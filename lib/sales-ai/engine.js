...
// La versione è una proprietà del prompt, non della configurazione: se il
// prompt cambia e la versione resta indietro, lo storico delle analisi diventa
// bugiardo. Quindi il default segue sempre il file, e la variabile d'ambiente
// resta solo come override esplicito per gli esperimenti.
const PROMPT_VERSION = '1.2-backend-it';

function promptVersion() {
  return process.env.SALES_AI_PROMPT_VERSION || PROMPT_VERSION;
}
